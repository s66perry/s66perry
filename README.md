...
- [MLIR DRR result pattern with constant StringAttr](https://discourse.llvm.org/t/mlir-drr-result-pattern-with-constant-stringattr/66275#post_1)
- [Marking SSA values as pointing to immutable memory](https://discourse.llvm.org/t/marking-ssa-values-as-pointing-to-immutable-memory/66249#post_6)
<!-- DISCOURSE-LLVM:END -->
