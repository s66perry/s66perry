...
- [[RFC] Allow ThinLTO to Rename Local Functions with Sections](https://discourse.llvm.org/t/rfc-allow-thinlto-to-rename-local-functions-with-sections/82981#post_2)
- [Why llvm.invariant.end intrinsic would prevent optimizations?](https://discourse.llvm.org/t/why-llvm-invariant-end-intrinsic-would-prevent-optimizations/82984#post_1)
