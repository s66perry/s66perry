...
- [LLVM 13.0.1-rc2 has been tagged plus changes to the upload process](https://llvm.discourse.group/t/llvm-13-0-1-rc2-has-been-tagged-plus-changes-to-the-upload-process/5551/12)
- [[PSA] Stop using StrEnumAttr &lpar;Do use EnumAttr&rpar;](https://llvm.discourse.group/t/psa-stop-using-strenumattr-do-use-enumattr/5710/1)
<!-- DISCOURSE-LLVM:END -->
