...
- [Why does LLVMConstInt take `unsigned long long`?](https://discourse.llvm.org/t/why-does-llvmconstint-take-unsigned-long-long/71900#post_3)
- [TBAA: `-new-struct-path-tbaa `status](https://discourse.llvm.org/t/tbaa-new-struct-path-tbaa-status/70349#post_5)
<!-- DISCOURSE-LLVM:END -->
