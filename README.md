...
- [How to make a LLVM variable be a pointer type and an integer type at the same time?](https://discourse.llvm.org/t/how-to-make-a-llvm-variable-be-a-pointer-type-and-an-integer-type-at-the-same-time/89354#post_3)
- [[mlir] Best practice for attribute type verification: parser vs verify](https://discourse.llvm.org/t/mlir-best-practice-for-attribute-type-verification-parser-vs-verify/89358#post_1)
<!-- DISCOURSE-LLVM:END -->
