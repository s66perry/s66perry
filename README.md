...
- [[Python Bindings] isolatedOp assertion failure when creating Block](https://discourse.llvm.org/t/python-bindings-isolatedop-assertion-failure-when-creating-block/72399#post_1)
<!-- DISCOURSE-LLVM:END -->
