...
- [[Question] Can I use an mlir attribute as the analysis state in the data flow analysis framework](https://discourse.llvm.org/t/question-can-i-use-an-mlir-attribute-as-the-analysis-state-in-the-data-flow-analysis-framework/88024#post_2)
<!-- DISCOURSE-LLVM:END -->
