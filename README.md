...
- [Should `APFloat` support the Arm alternative half-precision format?](https://discourse.llvm.org/t/should-apfloat-support-the-arm-alternative-half-precision-format/91617#post_1)
- [[RFC] Proposing a major LNT update &lpar;LNT v5&rpar;](https://discourse.llvm.org/t/rfc-proposing-a-major-lnt-update-lnt-v5/91595#post_3)
<!-- DISCOURSE-LLVM:END -->
